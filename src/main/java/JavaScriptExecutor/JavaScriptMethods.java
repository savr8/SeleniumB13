...
//        driver.manage().window().maximize();
        ...
        //We are saying to our driver ,work as executor
...
//        driver.manage().window().maximize();
        WebDriver driver= DriverHelper.getDriver();
        driver.get("https://www.techtorialacademy.com/");
        WebElement studentLoginBtn = driver.findElement(By.xpath("//div[@class=\"navigation hidden-xs\"]//a[.='Student login']"));
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].click()", studentLoginBtn);
    }

    @Test//THIS IS THE MOST COMMON INTERVIEW TECHNICAL AND VERBAL QESTION.**********
...
//        driver.manage().window().maximize();
        ...
        String title = js.executeScript("return document.title").toString();
        Assert.assertTrue(title.equals("Programs - Techtorial"));
